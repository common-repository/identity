 ...
 */
function MCI_Identity_requirePhpFiles($p_str_Directory) {
...
MCI_Identity_requirePhpFiles(dirname(__FILE__) . "/class");
MCI_Identity_requirePhpFiles(dirname(__FILE__) . "/class/dashboard");