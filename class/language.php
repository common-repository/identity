...
class MCI_Identity_Language {
	...
	public static function registerHooks() {
		add_action('plugins_loaded', array("MCI_Identity_Language", "loadTextDomain"));
	}
	...
	private static function load($p_str_LanguageCode) {
		return load_textdomain(MCI_Identity_Config::C_STR_PLUGIN_NAME,
			dirname(__FILE__) . "/../languages/" . MCI_Identity_Config::C_STR_PLUGIN_NAME . "-" . $p_str_LanguageCode . '.mo');
	}
